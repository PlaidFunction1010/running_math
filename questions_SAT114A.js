...
qs.push(fillQ(13,
  `已知三次多項式 $f(x)$ 除以 $x+6$ 得商式 $q(x)$ 和餘式 $3$，且 $q(x)$ 在 $x=-6$ 有最大值 $8$。<br>
  則 $y=f(x)$ 的圖形對稱中心坐標為
  $\\Big(\\,\\underline{\\phantom{99}}\\,\\underline{\\phantom{99}}\\; ,\\; \\underline{\\phantom{99}}\\Big)$。`,
  ["－","6","3"]
));

qs.push(fillQ(14,
  `點 $A(a,b,c)$ 與三平面 $E_1:4y+3z=2$、$E_2:3y+4z=-5$、$E_3:x+2y+2z=-2$ 的距離皆為 $6$。<br>
  則 $a+b+c=\\;\\underline{\\phantom{99}}\\;\\underline{\\phantom{99}}\\;\\underline{\\phantom{99}}\\;$。`,
  ["－","1","1"]
));

qs.push(fillQ(15,
  `假日市集玩偶遊戲，依擲硬幣次數決定價格。參與此遊戲的顧客購得一個玩偶所花金額的期望值為
  $\\;\\underline{\\phantom{99}}\\;\\underline{\\phantom{99}}\\;\\underline{\\phantom{99}}\\;$ 元。`,
  ["4","0","5"]
));

qs.push(fillQ(16,
  `設 $L_1,L_2$ 通過 $(3,1)$，斜率分別為 $m,-m$；圓 $\\Gamma$ 之圓心在原點。已知 $\\Gamma$ 與 $L_1$ 交於異點 $A,B$，且圓心到 $L_1$ 的距離為 $1$，$\\Gamma$ 與 $L_2$ 相切。<br>
  則弦 $AB$ 長為 $\\;\\underline{\\phantom{99}}\\;\\underline{\\phantom{99}}\\;\\underline{\\phantom{99}}\\;$（化為最簡分數）。`,
  ["2","4","5"]
));

qs.push(fillQ(17,
  `於 $\\triangle ABC$，$AB=BC=3$，且 $\\cos\\angle ABC=-\\tfrac{1}{2}$。外接圓上一點 $D$ 使得 $BD=4$ 且 $AD\\le CD$。<br>
  則 $CD=\\;\\underline{\\phantom{99}}\\; +\\; \\underline{\\phantom{99}}$（化為最簡根式）。`,
  ["3","2"]
));
